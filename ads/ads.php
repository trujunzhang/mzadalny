    ...
    <div class="col-xs-12  col-sm-9 col-md-9 col-lg-9 ">
        ...
        <div class="comment ad_div">
            ...
            <div class=" row ad_high">
                ...
                <div class=" comment_header">
                    &nbsp; <a href="<?php echo $fixed_htaccess; ?>users/<?php echo $username_member_2_m_ad; ?>"
                              class="username"><?php echo $username_member_2_m_ad; ?></a>
                    &nbsp; <?php echo $Time_added; ?> <a
                        href="<?php echo $fixed_htaccess; ?>city/<?php echo $ads_city; ?>/<?php echo $ads_city_name; ?>"
                        class="city-head"><?php echo $ads_city_name; ?></a>
                    <br>
                    رقم الاعلان : <?php echo $ads_id; ?>
                    <?php
                    if (($Last_updated_Ad_update === $time_add_ads) || $Last_updated_Ad_update === "0") {
                    } else {
                        ?>
                        <br>
                    ...
                    <div class="pull-left">
                        ...
                        if ($if_found_ad === 1) {
                            ?>
                            <a href="<?php echo $fixed_htaccess; ?>ads/<?php echo $new_id_link; ?>/<?php echo $new_title_link; ?>"
                               class="nextad"> الإعلان التالي ← </a>
                            <?php
                        }
                        ?>
                        <br>
            ...
            <div class="ad_low">
                ...
                if ($type_ads_other_final === "السيارات") {
                    ...
                    <?php if ($un_model === "model") { ?>
                        ...
                        <a class="tag fromad"
                           href="<?php echo $fixed_htaccess; ?>tags/<?php echo $ads_tags_FF; ?>/<?php echo $title_tag_FF; ?>"
                           title="<?php echo $title_tag_FF; ?>"><?php echo $title_tag_FF; ?></a>
                ...
                if ($id_user_m_ad === $id_member || $group_num === "1" || $group_num === "2") {
                    ...
                    <?php if ($close_ads === "6" || $close_ads === "1") { ?>
                        ...
                        <a href="<?php echo $fixed_htaccess; ?>close.php?ads_id=<?php echo $ads_id; ?>"><i
                                class="fa fa-trash-o"></i> حذف الإعلان </a>
                        <br>
                ...
                <a href="<?php echo $fixed_htaccess; ?>report_ads.php?link=<?php echo $fixed_htaccess; ?>ads/<?php echo $ads_id; ?>/<?php echo $ads_title; ?>"><i
                ...
                if (isset($_SESSION["'id_members'"])) {
                    ...
                    <a href="<?php echo $fixed_htaccess; ?>addfav.php?ads_id=<?php echo $ads_id; ?>"><i
                            class="fa fa-star"></i> إضافة للمفضلة </a>
                    <?php
                }
                ?>
        ...
        if ($id_user_m_ad !== $id_member) {
            ...
            <div class="alert alert-warning">
                ...
                نرجو الحذر من التعامل غير المباشر. نرجو إستخدام <a href="<?php echo $fixed_htaccess; ?>checkacc.php">القائمة
                    السوداء</a> قبل أي عملية تحويل
            </div>
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <ul>
                        ...
                        <li>لايحق لموقع <?php echo $namewebsite; ?> بمطالبة المشتري بالعمولة لعدم وجود أتفاق بيننا
                            وبينه.
                        </li>
                        <li>نرجو منك حذف الإعلان بعد بيع السلعة حفاظا لوقت زوار الموقع.</li>
                        <?php if ($closecomment === "0") {
                            $closecomment_arabic_st = "لمنع";
                        } else {
                            $closecomment_arabic_st = "لتفعيل";
                        } ?>
                        <li>
                            <a href="<?php echo $fixed_htaccess; ?>closecomment.php?ads_id=<?php echo $ads_id; ?>"><?php echo $closecomment_arabic_st; ?>
                                خاصية الردود أضغط هنا</a></li>
        ...
        <div class="row" style="position:relative;">
            <div style="position:absolute; bottom:5px;">
                ...
                <div class="fb-like"
                     data-href="<?php echo $fixed_htaccess; ?>/ads/<?php echo $ads_id; ?>/<?php echo $ads_title; ?>"
...
$fixed_htaccess" . "ads/$ads_id
                ...
                if ($execution_query_add_comments) {
                    ...
                    <meta http-equiv="refresh"
                          content="0;URL=<?php echo $fixed_htaccess; ?>ads/<?php echo $ads_id; ?>/<?php echo $ads_title; ?>">
		...
		ORDER BY RAND() limit 5";
                ...
                if ($result_keyinformation_print_num_rows > 0) {
                    ...
                    <div class="sidebar page-left-content">
                        <br>
                        إعلانات أخرى لـ: <a
                            href="<?php echo $fixed_htaccess; ?>users/<?php echo $username_member_2_m_ad; ?>"
                            class="username"><?php echo $username_member_2_m_ad; ?></a>
                        <br><br>
                ...
                <?php if ($result_keyinformation_print_num_rows_1 > 0) { ?>
                    ...
                    if ($type_ads_other_final === "السيارات") {
                        ...
                        <?php if ($un_model === "model") { ?>
                            ...
                            <a class="tag fromad"
                               href="<?php echo $fixed_htaccess; ?>tags/<?php echo $ads_tags_F; ?>/<?php echo $title_tag_F; ?>/<?php echo $ads_tags_FF; ?>/<?php echo $ads_city; ?>"
                               title="<?php echo $title_tag_FF; ?>"><?php echo $title_tag_F; ?> <?php echo $tag_year; ?>
                                في <?php echo $ads_city_name; ?></a>

                            <?php
                        } else {
                            ?>
                            <a class="tag fromad"
                               href="<?php echo $fixed_htaccess; ?>tags/<?php echo $ads_tags_F; ?>/<?php echo $title_tag_F; ?>/<?php echo $ads_tags_FF; ?>"
                               title="<?php echo $title_tag_F; ?>"><?php echo $title_tag_F; ?>
                                في <?php echo $ads_city_name; ?></a>

                            <a class="tag fromad"
                               href="<?php echo $fixed_htaccess; ?>tags/<?php echo $ads_tags_FF; ?>/<?php echo $title_tag_FF; ?>/<?php $ads_tags_FF; ?>"
                               title="<?php echo $title_tag_FF; ?>"><?php echo $title_tag_FF; ?>
                                في <?php echo $ads_city_name; ?></a>


                            <a class="tag fromad"
                               href="<?php echo $fixed_htaccess; ?>tags/<?php echo $ads_tags_R; ?>/<?php echo $title_name_tag_r; ?>/<?php echo $ads_tags_FF; ?>"
                               title="<?php echo $title_name; ?>"><?php echo $title_name_tag_r; ?>
                                في <?php echo $ads_city_name; ?></a>
                            <?php
                        }
                        ?>
                        ...
                        if (!empty($title_tag_FF)) {
                            ?>
                            <a class="tag fromad"
                               href="<?php echo $fixed_htaccess; ?>tags/<?php echo $ads_tags_FF; ?>/<?php echo $title_tag_FF; ?>/<?php echo $ads_city; ?>"
                               title="				<?php echo $title_tag_FF; ?>"><?php echo $title_tag_FF; ?>
                                في <?php echo $ads_city_name; ?></a>
                            <?php
                        } else {
                            ...
                            if (!empty($title_tag_F)) {
                                ?>
                                <a class="tag fromad"
                                   href="<?php echo $fixed_htaccess; ?>tags/<?php echo $ads_tags_F; ?>/<?php echo $title_tag_F; ?>/<?php echo $ads_city; ?>"
                                   title="<?php echo $title_tag_F; ?>"><?php echo $title_tag_F; ?>
                                    في <?php echo $ads_city_name; ?></a>
                                <?php
                            } else {
                                ...
                                if (!empty($title_name_tag_r)) {
                                    ?>
                                    <a class="tag fromad"
                                       href="<?php echo $fixed_htaccess; ?>tags/<?php echo $ads_tags_R; ?>/<?php echo $title_name_tag_r; ?>/<?php echo $ads_city; ?>"
                                       title="<?php echo $title_name; ?>"><?php echo $title_name_tag_r; ?>
                                        في <?php echo $ads_city_name; ?></a>
                                    <?php
                                }
                    ...
                    <?php if ($result_keyinformation_print_num_rows_1 > 0) {
                        ...
                        if ($type_ads_other_final === "السيارات") {
                            ...
                            <?php if ($un_model === "model") { ?>
                                ...
                                <a class="tag fromad"
                                   href="<?php echo $fixed_htaccess; ?>tags/<?php echo $ads_tags_F; ?>/<?php echo $title_tag_F; ?>/<?php echo $ads_tags_FF_mode_1; ?>/<?php echo $ads_city; ?>"
                                   title="<?php echo $ads_tags_FF_mode_1; ?>"><?php echo $title_tag_F; ?> <?php echo $tag_year_model_1; ?>
                                    في <?php echo $ads_city_name; ?></a>
                                ...
                                ?>
                                <a class="tag fromad"
                                   href="<?php echo $fixed_htaccess; ?>tags/<?php echo $ads_tags_F; ?>/<?php echo $title_tag_F; ?>/<?php echo $ads_tags_FF_mode_1; ?>"
                                   title="<?php echo $title_tag_F; ?>"><?php echo $title_tag_F; ?>
                                    في <?php echo $ads_city_name; ?></a>

                                <a class="tag fromad"
                                   href="<?php echo $fixed_htaccess; ?>tags/<?php echo $ads_tags_FF; ?>/<?php echo $title_tag_FF; ?>/<?php echo $ads_tags_FF_mode_1; ?>"
                                   title="<?php echo $title_tag_FF; ?>"><?php echo $title_tag_FF; ?>
                                    في <?php echo $ads_city_name; ?></a>


                                <a class="tag fromad"
                                   href="<?php echo $fixed_htaccess; ?>tags/<?php echo $ads_tags_R; ?>/<?php echo $title_name_tag_r; ?>/<?php echo $ads_tags_FF_mode_1; ?>"
                                   title="<?php echo $title_name; ?>"><?php echo $title_name_tag_r; ?>
                                    في <?php echo $ads_city_name; ?></a>
                                <?php
                            }
